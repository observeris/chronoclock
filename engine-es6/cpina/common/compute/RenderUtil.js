...
export default class RenderUtil {
    ...
    static createImage(renderSystem, texture, width, height) {
        ...
        // var gl = renderSystem.renderer.context;
        //
        // var theFBO = webglProperties.get(texture).__webglFramebuffer;
        // if (theFBO) {
        //
        //
        //     gl.bindFramebuffer(gl.FRAMEBUFFER, theFBO);
        //
        //     if (gl.checkFramebufferStatus(gl.FRAMEBUFFER) === gl.FRAMEBUFFER_COMPLETE) {
        //
        //         console.log('THREE.WebGLRenderer.readRenderTargetPixels: Framebuffer complete.');
        //
        //     } else {
        //
        //         console.error(
