    ...
    var TweenFunc = {
        ...
        */
        ...
        easeOutInElastic: function easeOutInElastic(t, b, c, d, a, p) {
            if (t < d / 2) return TweenFunc.easeOutElastic(t * 2, b, c / 2, d, a, p);
        ...
        easeOutInBack: function easeOutInBack(t, b, c, d, s) {
            if (t < d / 2) return TweenFunc.easeOutBack(t * 2, b, c / 2, d, s);
        ...
        easeInOutBounce: function easeInOutBounce(t, b, c, d) {
            if (t < d / 2) return TweenFunc.easeInBounce(t * 2, 0, c, d) * .5 + b;else return TweenFunc.easeOutBounce(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
        },
        easeOutInBounce: function easeOutInBounce(t, b, c, d) {
            if (t < d / 2) return TweenFunc.easeOutBounce(t * 2, b, c / 2, d);
        ...
        _createClass(AngleInterpolation, [{
            ...
            value: function LerpAngleConst(iCurrentTime) {
                ...
                if (normalizedLerpTime >= 0.0 && normalizedLerpTime < 1.0) {
                    var tweenFunc = TweenFunc[this.fTweenFunc];
    ...
    var DialRing = function () {
        ...
        _createClass(DialRing, [{
            ...
            value: function ScheduleAngleInterpolation(iNewAngleValue) {
                var lerpStruct = new AngleInterpolation(Date.now(), Date.now() + 700, this.fAngleRadians, iNewAngleValue, this.fTweenFunc);
